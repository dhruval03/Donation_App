...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      designSize: Size(360, 690), // Provide the design size of your UI
      builder: (context, _) => MaterialApp(
        title: 'Donor Registration Page',
        debugShowCheckedModeBanner: false,
        home: DonorRegistrationPage(),
      ),
    );
  }
}
                                    ...
                                    Visibility(
                                      ...
                                      child: Text(
                                        constraints.maxWidth >= 840
                                            ...
                                            : '"Feed Those Hungry Mouths, \n Put Clothes on Those Skinny Bones"',
                                        textAlign: TextAlign.justify,
                                        style: TextStyle(
                                          color: Colors.white,
                                  ...
                                  child: TextFormField(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      setState(() {
                                        ...
                                        _isFullNameNotEmpty = value.isNotEmpty;
                                      });
                                    },
                                    style: TextStyle(
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(
                                  horizontal: ScreenUtil().setWidth(
                                      8.0), // Adjusted horizontal padding
                                ),
                                child: Text(
                                  'or',
                                  style: TextStyle(
                                    ...
                                    fontSize: constraints.maxWidth >= 750
                                        ...
                                        : constraints.maxWidth >= 550
                                            ? 28
                                            : ScreenUtil().setSp(
                                                18), // Adjusted font size using ScreenUtil
                                  ),
                                ),
                              ),
                              Expanded(
